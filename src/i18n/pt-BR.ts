export const ptBR = {
  ...
  "results.rows": "Linhas:",
  "results.null": "NULO",
  "results.dismissError": "Clique para dispensar",
  ...
  "mcp.autoStart": "Iniciar automaticamente ao abrir o Amendoim",
  "mcp.confirmTitle": "Aprovar esta query?",
  "mcp.confirmDescription": "Uma query que pode alterar dados chegou pela porta do MCP. Ela ainda não rodou — revise antes.",
  "mcp.confirmCancel": "Não rodar",
  "mcp.confirmRun": "Rodar query",
