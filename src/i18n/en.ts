...
export const en: Record<TranslationKey, string> = {
  ...
  "mcp.confirmTitle": "Approve this query?",
  "mcp.confirmDescription": "A query that can modify data arrived over the MCP port. It has not run — review it first.",
  "mcp.confirmCancel": "Don't run",
  "mcp.confirmRun": "Run query",
