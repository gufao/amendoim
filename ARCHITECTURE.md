...
│   │   ├── secure/           # Integração com macOS Keychain para senhas
│   │   └── main.rs           # Inicializador do Tauri e registro de rotas
│   └── Cargo.toml            # Dependências nativas em Rust
├── Cargo.toml                # Configuração do Workspace Rust
├── package.json              # Script npm e metadados
└── pnpm-workspace.yaml       # Configuração do Workspace monorepo pnpm
```
